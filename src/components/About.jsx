  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 -left-40 w-[500px] h-[500px] bg-primary-500/8 rounded-full blur-[128px]" />
        <div className="absolute bottom-1/4 -right-40 w-[400px] h-[400px] bg-secondary-500/8 rounded-full blur-[128px]" />
      </div>
          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 mb-20">
            ...
            <ScrollReveal className="lg:col-span-2" direction="left">
              <div className="space-y-8">
                {/* Profile Image */}
                <div className="relative mx-auto w-64 h-64 lg:w-full lg:h-80">
                ...
                <div className="space-y-3">
                  {personalInfo.map((info) => {
                    ...
                    return (
                      <div key={info.label} className="flex items-center gap-3 p-3 rounded-xl glass glass-hover transition-all">
                        <div className="w-10 h-10 rounded-lg bg-primary-500/10 flex items-center justify-center">
                          <Icon className="w-4 h-4 text-primary-400" />
                        </div>
                        <div>
                          <p className="text-xs text-dark-500">{info.label}</p>
                          <p className="text-sm text-dark-200 font-medium">{info.value}</p>
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="lg:col-span-3 space-y-10">
                  ...
                  {stats.map((stat, i) => {
                    ...
                    return (
                      <GlassCard key={stat.label} className="p-4 text-center">
                        <div className="w-10 h-10 mx-auto mb-2 rounded-lg bg-gradient-to-br from-primary-500/20 to-secondary-500/20 flex items-center justify-center">
              ...
              <ScrollReveal delay={0.4}>
                <h4 className="text-lg font-semibold font-display mb-4">Tech Stack</h4>
              ...
              return (
                <ScrollReveal key={value.title} delay={i * 0.1}>
                  <GlassCard className="p-6 h-full group">
                    ...
                    <h4 className="text-lg font-bold font-display mb-2">{value.title}</h4>
